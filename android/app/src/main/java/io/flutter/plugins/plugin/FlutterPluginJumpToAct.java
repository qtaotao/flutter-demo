package io.flutter.plugins.plugin;
...
import io.flutter.plugins.OneActivity;
import io.flutter.plugins.TwoActivity;

public class FlutterPluginJumpToAct implements MethodChannel.MethodCallHandler {

    public static String CHANNEL = "com.qbt.jump/plugin";
