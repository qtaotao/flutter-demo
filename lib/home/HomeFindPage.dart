...
import 'package:flutter_app/model/HomeFind.dart';
import 'package:flutter_app/widget/widget_listmultiview.dart';

import '../DailsPage.dart';
      ...
      return GestureDetector(
        onTap: () {
          ...
          Navigator.of(context)
            ...
            return DailsPage(name: homeFindList[index].name);
          }));
        },
        child: Column(
          children: <Widget>[
